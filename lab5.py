...
def lab4():
    ...
    glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, [0, 0, 1, 0])
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, 50)


    glEnable(GL_LIGHT0)
    glLightfv(GL_LIGHT0, GL_AMBIENT, [0.0, 0.0, 0.5, 0.2]) # sphere color
    glLightfv(GL_LIGHT0, GL_DIFFUSE, [0.0, 1.0, .0, 1]) # light color

    glEnable(GL_LIGHT1)
    # glLightfv(GL_LIGHT1, GL_AMBIENT, [0.5, 0.5, 0.5, 1])  # sphere color
    glLightfv(GL_LIGHT1, GL_DIFFUSE, [1.0, 0.0, 0.0, 1])  # light color
    ...
    while run:
        ...
        # glLightfv(GL_LIGHT0, GL_POSITION, lightpos)
        lightpos = (math.cos(coef), 2.0, math.cos(coef))
        ...
        glEnable(GL_LIGHT0)
        glLightfv(GL_LIGHT0, GL_AMBIENT, [0.0, 1.0, 0.0, 0.2])  # sphere color
        glLightfv(GL_LIGHT0, GL_DIFFUSE, [0.0, 1.0, .0, 1])  # light color
